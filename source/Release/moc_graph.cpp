...
void Graph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Graph::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Graph::process)) {
                *result = 0;
                return;
            }
        }
